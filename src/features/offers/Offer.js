...
export const Offer = () => {
  return (
    <section className="offer-container container bg-light rounded overflow-hidden shadow shadow-md my-3 p-0">
      <div className="row m-auto">
      
        <div className="col  col-xl-4 d-flex flex-row  flex-md-row flex-xl-column m-0 p-0">
          <div className="col-4 col-xl-12 offer-header-image p-0 m-0">
            <img
          ...
          <div className="col  grocery-categories d-flex flex-row flex-wrap align-items-center m-0 p-0">
